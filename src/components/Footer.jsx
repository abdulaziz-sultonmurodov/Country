      ...
      <nav className="flex flex-col lg:flex-row items-start lg:items-center justify-between px-10 py-5">
        ...
        <ul className="flex flex-col lg:flex-row my-4 lg:my-0">
          {countries.map((country) => (
            <li
              key={country.id}
              className="hover:text-gray-800 cursor-pointer my-2 mx-4"
            >
        ...
        <div className="mx-auto lg:mx-0">
          <a
            className="flex hover:text-gray-800 items-center"
            href="https://github.com/abdulaziz-sultonmurodov"
            target="_blank"
            rel="noreferrer"
          >
            Github <IoLogoGithub className="h-6 w-6 ml-2" />{" "}
          </a>
        </div>
      </nav>
